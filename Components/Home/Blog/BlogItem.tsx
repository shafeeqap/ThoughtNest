...
const BlogItem: React.FC<BlogItemType> = ({ title, description, category, image }) => {
    return (
        <div className='max-w-[330px] sm:max-w-[300px] bg-white border border-black transition-all hover:scale-105 duration-500'>
            ...
            <div className="p-5">
                ...
                <p className='mb-3 text-sm tracking-tight text-gray-500'>{description}</p>
                <div className='inline-flex items-center py-2 font-semibold text-center gap-2 cursor-pointer'>
