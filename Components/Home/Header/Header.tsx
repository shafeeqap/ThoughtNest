...
const Header: React.FC = () => {
    ...
    return (
        <div className={`${headerBgColor ? 'bg-black/80 backdrop-blur-sm transition-colors duration-300' : ''} py-5 px-5 md:px-12 lg:px-8 z-[1000] fixed w-full top-0 shadow-lg`}>
