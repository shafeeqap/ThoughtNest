            ...
            {editor && (
                <div className='mb-2 grid grid-cols-4 sm:flex gap-2 border-b pb-2'>
                    ...
                    <button
                        ...
                        className={`border p-1 rounded flex justify-center cursor-pointer w-10 sm:w-fit hover:bg-gray-200 ${editor.isActive('heading', { level: 2 }) ? 'text-blue-600 bg-gray-100' : ''}`}
                    >
                        H2
                    </button>
                    <button
                        ...
                        className={`border p-1 rounded flex justify-center cursor-pointer w-10 sm:w-fit hover:bg-gray-200 ${editor.isActive('heading', { level: 3 }) ? 'text-blue-600 bg-gray-100' : ''}`}
                    >
                        H3
                    </button>
                    <button
                        ...
                        className={`border p-1 rounded flex justify-center cursor-pointer w-10 sm:w-fit hover:bg-gray-200 ${editor.isActive('heading', { level: 4 }) ? 'text-blue-600 bg-gray-100' : ''}`}
                    >
                        H4
                    </button>
                    <button
