...
export default async function ViewAllBlogs({ params }: { params: Promise<{ category: string }> }) {
    ...
    return (
        <div className="flex flex-col justify-center items-center">
            <div className="flex justify-center items-center w-full h-[350px] bg-[#616263]">
                <div className="flex flex-col justify-center items-center mt-10 px-5">
                    ...
                    <p className="text-center font-light text-lg max-w-3xl leading-5.5 text-white">Lorem ipsum dolor sit amet consectetur adipisicing elit. Totam delectus culpa, dolorum nihil eum autem saepe eligendi tenetur debitis, hic laborum numquam...</p>
                </div>
            </div>
